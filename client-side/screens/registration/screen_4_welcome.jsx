      ...
      <ScrollView contentContainerStyle={twrnc`flex w-full h-full`}>
        <View style={twrnc`flex w-full h-full flex-col mt-11 relative `}>
          ...
          <View style={twrnc`flex items-center justify-center mt-2`}>
            ...
            <Text style={twrnc`font-normal text-base text-gray-400`}>
          ...
          <View style={twrnc`mt-32 mx-5`}>
            <View style={twrnc`mb-2 flex flex-col  justify-between`}>
              ...
              <View style={twrnc`mb-3 -mt-4`}>
                <TextInput
                  style={twrnc`h-12 w-full pt-5 text-${
                    !isDarkMode ? "black" : "white"
                  }`}
            ...
            {loading && (
              <View
                style={twrnc`absolute inset-0 items-center justify-center flex-1 flex`}
              >
          ...
          <View style={twrnc`mx-5 flex  items-end justify-center`}>
            <TouchableOpacity onPress={handleForgotPasswordNavigation}>
              <Text style={twrnc`text-red-500 font-normal text-base`}>
                Forgot Password?
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View
            style={twrnc`mt-8 flex items-center justify-between flex-row mx-5`}
          >
            <Text
          ...
          <View style={twrnc`mt-20 flex items-center justify-center mx-5`}>
            <Text
              style={twrnc`text-center text-${!isDarkMode ? "black" : "white"}`}
            >
          ...
          <View
            style={twrnc`flex items-center   absolute bottom-0 mt-auto bg-purple-500 w-full h-24 flex`}
          >
            <TouchableOpacity
              style={twrnc`w-full h-full flex items-center justify-center pt-5`}
              onPress={handleSubmit}
            >
              <Text
                style={twrnc` flex items-center justify-center mb-auto text-white text-center font-semibold`}
              >
                Login{" "}
              </Text>
            </TouchableOpacity>
