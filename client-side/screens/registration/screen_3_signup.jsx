...
const SignUp = ({ navigation }) => {
      ...
      auth
        ...
        .then((userCredential) => {
          ...
          user
            ...
            .then(() => {
              console.log(
                "User account created & signed in with username:",
                user
              );
              setLoading(false);
  ...
  return (
    ...
    >
      ...
      <View style={twrnc`mt-32 mx-5`}>
        <View style={twrnc`mb-2 flex flex-col  justify-between`}>
          <Text style={twrnc`font-normal text-base text-gray-800`}>
            Username
          </Text>
    ...
    text-${!isDarkMode ? "black" : "white"}`}
      ...
      <View
        style={twrnc`flex items-center   absolute bottom-0 mt-auto bg-purple-500 w-full h-14 flex`}
      >
        <TouchableOpacity
