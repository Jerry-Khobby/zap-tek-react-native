...
const VerificationCode = () => {
  return (
    <View className="flex flex-col h-screen">
      <TouchableOpacity
        className="h-11 w-11 bg-gray-100 items-center justify-center rounded-full ml-3 relative top-3"
      >
      ...
      <View className="flex-row flex-1 mt-36 items-center justify-center">
