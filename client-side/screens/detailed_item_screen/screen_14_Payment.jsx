...
const Payment = ({ navigation }) => {
  ...
  return (
    <View
      style={twrnc`flex flex-1 w-full h-full flex-col pt-10 relative ${
    ...
    >
      ...
      <View style={twrnc`mx-5 flex items-center flex-row justify-between `}>
        ...
        <View className="mr-5">
          <Text
            style={twrnc`text-2xl font-bold ${
      ...
      <View className=" mt-1 mx-3">
        <TouchableOpacity
          className="flex flex-row bg-purple-100 border border-purple-600 h-14 items-center justify-center rounded-md"
          onPress={addNewCard}
        >
          <AntDesign
            name="plussquareo"
            size={16}
            color="white"
            style={twrnc`mr-2  text-purple-600 `}
          />
          <Text
            style={twrnc`text-white text-base font-medium  text-purple-600 `}
          >
            Add a new Card
          </Text>
        </TouchableOpacity>
      ...
      <View
        style={twrnc`flex-1 justify-center items-center top-full absolute  w-full h-16 bg-purple-500 bottom-0 pb-4`}
      >
        <TouchableOpacity
