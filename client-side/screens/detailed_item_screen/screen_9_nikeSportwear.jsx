...
const NikeSportsWear = ({ navigation }) => {
  const brand = useSelector((state) => state.product.selectedProduct);
  // dark mode works
          ...
          <View style={twrnc`mx-4`}>
            <View>
              <View style={twrnc`flex-row justify-between mt-3`}>
                <Text style={twrnc`text-gray-500`}>{brand.product}</Text>
                <Text style={twrnc`text-gray-500 mr-2`}>Price</Text>
              </View>
