...
const {isDarkMode}=useDarkMode();
    ...
    return(
        <SafeAreaView style={!isDarkMode?twrnc`bg-white h-full` :twrnc`bg-black h-full`}>
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={!isDarkMode?twrnc `mx-5`:twrnc`mx-5`}>
                    ...
                    <View style={twrnc `flex-row mt-5 items-center`}>
                        <View>
                            <TouchableOpacity style={!isDarkMode? twrnc `bg-gray-200 h-12 w-12 mt-2 rounded-full`:twrnc`h-12 w-12 mt-2 rounded-full bg-gray-700`} onPress={handleBackWardNavigation}>
                        ...
                        <Text style={!isDarkMode?twrnc `mx-24 mt-5 text-2xl font-semibold`:twrnc`mx-24 mt-5 text-2xl font-semibold text-white`}>Reviews</Text>
                    </View>

                    <View style={twrnc `mt-4 flex-row justify-between`}>
                        <View>
                            <Text style={!isDarkMode?twrnc `font-semibold`:twrnc`font-semibold text-white`}>245 Reviews</Text>
                    ...
                    <View style={twrnc `mt-5`}>
                        <View style={twrnc `mt-4 flex-row`}>
                            ...
                            <View style={twrnc `flex-row`}>
                                <View style={twrnc `ml-2`}>
                                    <Text style={!isDarkMode ? twrnc`ml-1 font-bold` : twrnc`ml-1 font-bold text-white`}>Jenny Wilson</Text>
                        ...
                        <View style={twrnc `mt-4 flex-row`}>
                            ...
                            <View style={twrnc `flex-row`}>
                                <View style={twrnc `ml-2`}>
                                    <Text style={!isDarkMode ? twrnc`ml-1 font-bold` : twrnc`ml-1 font-bold text-white`}>Ronald Richards</Text>
                                    <View style={twrnc `flex-row mt-2`}>
                                        <EvilIcons name="clock" size={24} color="gray" />
                                        <Text style={twrnc `text-gray-500`}>13 Sep, 2020</Text>
                                    </View>
                        ...
                        <View style={twrnc `mt-4 flex-row`}>
                            ...
                            <View style={twrnc `flex-row`}>
                                <View style={twrnc `ml-2`}>
                                    <Text style={!isDarkMode ? twrnc`ml-1 font-bold` : twrnc`ml-1 font-bold text-white`}>Guy Hawkins</Text>
                                    <View style={twrnc `flex-row mt-2`}>
                                        <EvilIcons name="clock" size={24} color="gray" />
                                        <Text style={twrnc `text-gray-500`}>13 Sep, 2020</Text>
                                    </View>
                        ...
                        <View style={twrnc `mt-4 flex-row`}>
                            ...
                            <View style={twrnc `flex-row`}>
                                <View style={twrnc `ml-2`}>
                                    <Text style={!isDarkMode ? twrnc`ml-1 font-bold` : twrnc`ml-1 font-bold text-white`}>Savannah Nguyen</Text>
                                    <View style={twrnc `flex-row mt-2`}>
                                        <EvilIcons name="clock" size={24} color="gray" />
                                        <Text style={twrnc `text-gray-500`}>13 Sep, 2020</Text>
                                    </View>
